...
if use_database_url:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("SQLITE_PATH", "/var/data/db.sqlite3"),
        }
    }
...
SELLER_NAME = env("SELLER_NAME", "Anaacoss")
SELLER_ADDRESS = env("SELLER_ADDRESS", "Beauty Atelier, New Delhi")
SELLER_GSTIN = env("SELLER_GSTIN", "")
SELLER_STATE = env("SELLER_STATE", "Delhi")
SELLER_WAREHOUSE_ADDRESS = env("SELLER_WAREHOUSE_ADDRESS", SELLER_ADDRESS)
SELLER_REGISTERED_ADDRESS = env("SELLER_REGISTERED_ADDRESS", SELLER_ADDRESS)
SELLER_SIGNATURE_NAME = env("SELLER_SIGNATURE_NAME", SELLER_NAME)
INVOICE_HELP_TEXT = env("INVOICE_HELP_TEXT", "If you have any questions, feel free to call customer care.")
BRAND_LOGO_TEXT = env("BRAND_LOGO_TEXT", "Anaacoss")
